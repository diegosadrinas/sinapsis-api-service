...
export const createPresignedUrlForGetRequest = ({ region, bucket, key }) => {
    try {
...
export const uploadPresignedObject = async ({ region, bucket, key }, buffer) => {
    try {
...
//# sourceMappingURL=bucket-actions.js.map